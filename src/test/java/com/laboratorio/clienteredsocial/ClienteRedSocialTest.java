...
public class ClienteRedSocialTest {
    ...
    private void verificarPosiblesSeguidores(NombreRedSocial nombreRedSocial, String accountId, String accessToken, String urlBase) throws Exception {
        int quantity = 50;
    ...
    public void verificarPosiblesSeguidoresMastodon() throws Exception {
        ...
        this.verificarPosiblesSeguidores(NombreRedSocial.MASTODON, accountId, accessToken, urlBase);
    } */
    ...
    public void verificarPosiblesSeguidoresBluesky() throws Exception {
        ...
        String urlBase = "";
        this.verificarPosiblesSeguidores(NombreRedSocial.BLUESKY, accountId, accessToken, urlBase);
    } */
    ...
    public void verificarPosiblesSeguidoresTruthsocial() throws Exception {
        ...
        String urlBase = "";
        this.verificarPosiblesSeguidores(NombreRedSocial.TRUTHSOCIAL, accountId, accessToken, urlBase);
    } */
    ...
    public void verificarPosiblesSeguidoresGettr() throws Exception {
        ...
        String urlBase = "";
        this.verificarPosiblesSeguidores(NombreRedSocial.GETTR, accountId, accessToken, urlBase);
    } */
    ...
    public void verificarPosiblesSeguidoresGab() throws Exception {
        ...
        String urlBase = "";
        this.verificarPosiblesSeguidores(NombreRedSocial.GAB, accountId, accessToken, urlBase);
    } */
    ...
    public void verificarPosiblesSeguidoresMinds() throws Exception {
        ...
        String accessToken = "";
        String urlBase = "";
        this.verificarPosiblesSeguidores(NombreRedSocial.MINDS, accountId, accessToken, urlBase);
    } */
    ...
    public void verificarPosiblesSeguidoresParler() throws Exception {
        ...
        String urlBase = "";
        this.verificarPosiblesSeguidores(NombreRedSocial.PARLER, accountId, accessToken, urlBase);
    } */
}